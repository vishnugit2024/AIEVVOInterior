...
import ModularWood from "../../Assets/AIEBanner4.webp";
...
const MoreService = () => {
  ...
  const services = [
    {
      ...
      description:
        "Great design is transparent to the user and striking to the observer. If you are a house owner looking for a cozy space, we meet your needs. We at AIEVVO ENGINEERS have facility for a consultation with a designer to start your home interior process.",
    ...
    },
    {
      ...
      description:
        "Woodwork offers an artistic touch to the interior. It looks elegant and rich when done right. We at AIEVVO ENGINEERS have our facility for PreLam factory-made boards with HD gloss/mat lamination finish for shutters of kitchen and bedroom woodwork.",
  ...
  return (
    <>
      <SEO 
        title="Our Services | Interior Design, Modular Furniture & Fabrication"
        description="Explore Aievvo Engineers Pvt. Ltd.'s expert services: interior design, modular furniture, home renovation, office space optimization, steel & wood fabrication, and more."
        keywords="Interior Design Services, Modular Furniture Solutions, Home Renovation, Office Space Optimization, Custom Fabrication, 3D Design, Smart Storage Solutions"
      />
